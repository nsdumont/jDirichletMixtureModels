...
function nc1_pdf(y::Float64,μ,λ,μ0,n0,α0,β0)
  pdf(NormalCanon(λ*μ, λ), y)
end
function nc1_pdf(y::Array{Float64},μ,λ,μ0,n0,α0,β0)
  pdf.(NormalCanon(λ*μ, λ), y)
end
function nc1_post(Y::Array{Float64,1}, μ0,n0,α0,β0)
  p=posterior_canon(NormalGamma(μ0,n0,α0,β0),suffstats(Normal,Y))
  rand(p)
end
function nc1_post(y::Float64, μ0,n0,α0,β0)
  p=posterior_canon(NormalGamma(μ0,n0,α0,β0),suffstats(Normal,[y]))
  rand(p)
end
function nc1_pri(μ0,n0,α0,β0)
  rand(NormalGamma(μ0,n0,α0,β0))
end
function nc1_marg(y::Float64,μ0,n0,α0,β0)
